...
function onclickBegin(){
  ...
  let score = 0;
  let ifult = false;
  var audioBoom = new Audio('audio/aw.mp3');
  var audioBeer = new Audio('audio/wuhu.mp3');
  var audioUlt = new Audio('audio/ult.mp3');
  const imgdead = new Image();
  imgdead.src = 'img/boom.png';

  const imgone = new Image();
  imgone.src = 'img/unicornchar.png';
  imgone.onload = () => {
    context.drawImage(imgone, hero.xPos, hero.yPos, 50 , 50);
    imgone.onload = null;
  };
  const imgult = new Image();
  imgult.src = 'img/immune.png';
  ...
  function checkDeath(bomb, hero, img, ctx){
    ...
    if(xny){
      ...
      if(lives==2){
        ...
        document.getElementById('alienlife3').style.display="none";
      }else if(lives==1){
        document.getElementById('life2').style.display="none";
        document.getElementById('alienlife2').style.display="none";
      }else if(lives==0){
        document.getElementById('life1').style.display="none";
        document.getElementById('alienlife1').style.display="none";
      };
      // alert(lives);
      if(lives<0){
  ...
  // alien character selected
  function changeChar(){
    context.clearRect(0, 0, context.canvas.width, context.canvas.height);
    imgone.src = 'img/alienchar.png';
    canvas.width=canvas.width;
    context.drawImage(imgone, hero.xPos, hero.yPos, 50, 50);
    document.getElementById('life1').style.display="none";
    document.getElementById('life2').style.display="none";
    document.getElementById('life3').style.display="none";
    document.getElementById('alienlife1').style.display="block";
    document.getElementById('alienlife2').style.display="block";
    document.getElementById('alienlife3').style.display="block";
    document.getElementById('alienID').style.opacity="0.5";
    document.getElementById('unicornID').style.opacity="1";
    imgult.src = 'img/alienimmune.png';
  }
  // unicorn character selected
  function changeToUni(){
    context.clearRect(0, 0, context.canvas.width, context.canvas.height);
    imgone.src = 'img/unicornchar.png';
    canvas.width=canvas.width;
    context.drawImage(imgone, hero.xPos, hero.yPos, 50, 50);
    ...
    document.getElementById('alienlife2').style.display="none";
    document.getElementById('alienlife3').style.display="none";
    document.getElementById('alienID').style.opacity="1";
    document.getElementById('unicornID').style.opacity="0.5";
    imgult.src = 'img/immune.png';
  }
